namespace DreamScannerApp.UserControls.TeacherUserControls
{
    partial class Teachers
    {
        ...
        private void InitializeComponent()
        {
            ...
            btnViewLogs.Location = new Point(713, 16);
            ...
            btnViewLogs.Values.Text = "View Teacher Logs";
            // 
            // btnAddTeacher
            // 
            btnAddTeacher.Anchor = AnchorStyles.Top | AnchorStyles.Right;
            btnAddTeacher.Location = new Point(883, 16);
            btnAddTeacher.Name = "btnAddTeacher";
            btnAddTeacher.OverrideDefault.Back.Color1 = Color.Red;
            btnAddTeacher.OverrideDefault.Back.Color2 = Color.FromArgb(192, 0, 0);
            btnAddTeacher.OverrideDefault.Back.ColorAngle = 130F;
            btnAddTeacher.OverrideDefault.Border.Color1 = Color.Red;
            btnAddTeacher.OverrideDefault.Border.Color2 = Color.FromArgb(192, 0, 0);
            btnAddTeacher.OverrideDefault.Border.ColorAngle = 130F;
            btnAddTeacher.OverrideDefault.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            btnAddTeacher.OverrideDefault.Border.Rounding = 18F;
            btnAddTeacher.OverrideDefault.Content.ShortText.Color1 = Color.White;
            btnAddTeacher.OverrideDefault.Content.ShortText.Color2 = Color.White;
            btnAddTeacher.OverrideDefault.Content.ShortText.Font = new Font("Archivo", 9F, FontStyle.Bold, GraphicsUnit.Point);
            btnAddTeacher.Size = new Size(164, 38);
            btnAddTeacher.StateCommon.Back.Color1 = Color.Red;
            btnAddTeacher.StateCommon.Back.Color2 = Color.FromArgb(192, 0, 0);
            btnAddTeacher.StateCommon.Back.ColorAngle = 45F;
            btnAddTeacher.StateCommon.Border.Color1 = Color.Red;
            btnAddTeacher.StateCommon.Border.Color2 = Color.Red;
            btnAddTeacher.StateCommon.Border.ColorAngle = 130F;
            btnAddTeacher.StateCommon.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            btnAddTeacher.StateCommon.Border.Rounding = 18F;
            btnAddTeacher.StateCommon.Content.ShortText.Color1 = Color.White;
            btnAddTeacher.StateCommon.Content.ShortText.Color2 = Color.White;
            btnAddTeacher.StateCommon.Content.ShortText.Font = new Font("Archivo", 8F, FontStyle.Bold, GraphicsUnit.Point);
            btnAddTeacher.StatePressed.Back.Color1 = Color.Red;
            btnAddTeacher.StatePressed.Back.Color2 = Color.Red;
            btnAddTeacher.StatePressed.Back.ColorAngle = 45F;
            btnAddTeacher.StatePressed.Border.Color1 = Color.Red;
            btnAddTeacher.StatePressed.Border.Color2 = Color.Red;
            btnAddTeacher.StatePressed.Border.DrawBorders = Krypton.Toolkit.PaletteDrawBorders.Top | Krypton.Toolkit.PaletteDrawBorders.Bottom | Krypton.Toolkit.PaletteDrawBorders.Left | Krypton.Toolkit.PaletteDrawBorders.Right;
            btnAddTeacher.StatePressed.Border.Rounding = 18F;
            btnAddTeacher.StatePressed.Content.ShortText.Color1 = Color.White;
            btnAddTeacher.StatePressed.Content.ShortText.Color2 = Color.White;
